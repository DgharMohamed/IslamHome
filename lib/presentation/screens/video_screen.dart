...
class _VideoScreenState extends ConsumerState<VideoScreen> {
  ...
  Future<void> _playEpisode(
    ...
    try {
      ...
      if (audioService == null) {
        if (mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(l10n.audioServiceNotReady),
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(l10n.failedToPlay(e.toString())),
  ...
  Widget _getReciterImage(String? reciterName) {
    ...
    final Map<String, String> reciterImages = {
      ...
      'Mufti Ismail Menk':
          'https://muftimenk.com/wp-content/uploads/2019/12/mufti-ismail-menk.jpg',
      'أبو إسحاق الحويني':
          'https://alheweny.me/wp-content/uploads/2021/01/cropped-alheweny-logo-1.png',
      'الشيخ محمد العريفي':
          'https://archive.org/download/islami-586_202402/__ia_thumb.jpg',
    };
