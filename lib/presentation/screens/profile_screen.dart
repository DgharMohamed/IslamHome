...
class ProfileScreen extends ConsumerWidget {
                  ...
                  children: [
                    ...
                    if (user != null && !user.isAnonymous) ...[
                      ...
                      _buildMenuItem(
                        ...
                        onTap: () => _showEditProfileDialog(context, ref, l10n, user),
                      ),
                    ],
                    if (user != null)
                      _buildMenuItem(
      ...
      child: Column(
        children: [
          ...
          ElevatedButton(
            ...
            child: Text(l10n.createAccountNow, style: const TextStyle(fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
  ...
  Widget _buildAppBar(BuildContext context, AppLocalizations l10n, User? user) {
    ...
    final name = user?.displayName ?? (isGuest ? l10n.guestUser : l10n.unknownName);
              ...
              Stack(
                children: [
                  CircleAvatar(
                    ...
                    child: user?.photoURL == null ? const Icon(Icons.person, size: 55, color: Colors.white) : null,
                  ),
                  if (user != null && !user.isAnonymous)
                    Positioned(
                      bottom: 0,
  ...
  void _showEditProfileDialog(BuildContext context, WidgetRef ref, AppLocalizations l10n, User user) {
  ...
  void _showDeleteAccountDialog(BuildContext context, WidgetRef ref, AppLocalizations l10n) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text(l10n.deleteAccountConfirmTitle, style: const TextStyle(color: Colors.red)),
