            ...
            _buildSettingTile(
              ...
              trailing: Switch.adaptive(
                ...
                onChanged: (value) async {
                  // This updates both the UI and triggers PrayerNotifier to re-evaluate schedules
                  ref.read(prayerNotifierProvider.notifier).toggleAthan(value);

                  if (!value) {
                    await NotificationService().cancelAll();
                  } else {
                    // Force a refresh to reschedule notifications if re-enabled
